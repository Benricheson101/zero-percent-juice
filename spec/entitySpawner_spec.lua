...
describe('EntitySpawner', function()
    describe('new', function()
        it(
            'creates a new instance of entitySpawner with the correct parameters',
            function()
    ...
    describe('update', function()
        it(
            'Updates entities and determines if a new entity should be spawned in',
            function()
                ---@diagnostic disable-next-line: redundant-parameter
                local entitySpawner = EntitySpawner:new {
                    spawnUpgradeName = 'Rock Reducer',
    ...
    describe('checkCollision', function()
        it(
            'Checks if any entities are colliding with another object at the given dimensions',
            function()
                ---@diagnostic disable-next-line: redundant-parameter
                local entitySpawner = EntitySpawner:new {
                    spawnUpgradeName = 'Rock Reducer',
