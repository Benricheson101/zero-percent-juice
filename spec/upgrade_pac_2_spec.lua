...
describe('Booster Upgrade', function()
    ...
    it('spawn frequency calculation', function()
        --test that the spawn frequency goes up
        local initalSpawnFrequency = game.powerUpSpawnerFrequencyCalcilation(0)
        local spawnFrequency1 = game.powerUpSpawnerFrequencyCalcilation(1)
        local spawnFrequency2 = game.powerUpSpawnerFrequencyCalcilation(2)
    ...
    it('spawn frequency function applied', function()
        local expectedSpawnFrequency = game.powerUpSpawnerFrequencyCalcilation(2)
        assert.is_true(
            expectedSpawnFrequency == game.PowerUpSpawner.spawnUpgradeEffectFunc(2)
        )
        local expectedSpawnFrequency = game.powerUpSpawnerFrequencyCalcilation(3)
        assert.is_true(
            expectedSpawnFrequency == game.PowerUpSpawner.spawnUpgradeEffectFunc(3)
        )
        local expectedSpawnFrequency = game.powerUpSpawnerFrequencyCalcilation(4)
        assert.is_true(
