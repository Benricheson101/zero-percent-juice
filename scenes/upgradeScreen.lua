...
local function drawTank(pressure, selected)
    ...
    love.graphics.draw(
        ...
        topTankY,
        0,
        tankWidth / tankTop:getWidth(),
        topHeight / tankTop:getHeight()
    )
    ...
    love.graphics.draw(
        ...
        topTankY + topHeight,
        0,
        tankWidth / tankBody:getWidth(),
        bodyHeight / tankBody:getHeight()
    )
    ...
    love.graphics.rectangle(
        ...
        0,
        Ui:scaleDimension(-5),
        Ui:scaleDimension(115),
        Ui:scaleDimension(10)
    )
...
function UpgradeScreen.calculateUpgradePosition(index)
...
local function drawUpgrade(index, hilighted)
    ...
    love.graphics.rectangle(
        ...
        upgradeX,
        upgradeY,
        Ui:scaleDimension(200),
        Ui:scaleDimension(130)
    )
    if hilighted == 0 then
    ...
    love.graphics.rectangle(
        ...
        upgradeY,
        Ui:scaleDimension(200),
        Ui:scaleDimension(80)
    )
    love.graphics.rectangle(
        'line',
        upgradeX,
        upgradeY + Ui:scaleDimension(80),
        Ui:scaleDimension(100),
        Ui:scaleDimension(50)
    )
    love.graphics.rectangle(
        'line',
        upgradeX + Ui:scaleDimension(100),
        upgradeY + Ui:scaleDimension(80),
        Ui:scaleDimension(100),
        Ui:scaleDimension(50)
    )
...
function UpgradeScreen:draw()
    ...
    local jitter = math.sin(love.timer.getTime() * 50 * distancePercent)
        * 0.03
        * distancePercent
    ...
    love.graphics.rectangle(
        'fill',
        platformX,
        love.graphics.getHeight() - Ui:scaleDimension(50),
        Ui:scaleDimension(1160),
        Ui:scaleDimension(10)
    )
    --ramp 1
    love.graphics.push()
    love.graphics.translate(
        platformX + Ui:scaleDimension(3),
        love.graphics.getHeight() - Ui:scaleDimension(45)
    )
    ...
    love.graphics.push()
    love.graphics.translate(
        platformX + Ui:scaleDimension(1157),
        love.graphics.getHeight() - Ui:scaleDimension(45)
    )
    ...
    love.graphics.rectangle(
        'fill',
        platformX + Ui:scaleDimension(40),
        love.graphics.getHeight() - Ui:scaleDimension(50),
        Ui:scaleDimension(10),
        Ui:scaleDimension(50)
    )
    love.graphics.rectangle(
        'fill',
        platformX + Ui:scaleDimension(310),
        love.graphics.getHeight() - Ui:scaleDimension(50),
        Ui:scaleDimension(10),
        Ui:scaleDimension(50)
    )
    love.graphics.rectangle(
        'fill',
        platformX + Ui:scaleDimension(575),
        love.graphics.getHeight() - Ui:scaleDimension(50),
        Ui:scaleDimension(10),
        Ui:scaleDimension(50)
    )
    love.graphics.rectangle(
        'fill',
        platformX + Ui:scaleDimension(850),
        love.graphics.getHeight() - Ui:scaleDimension(50),
        Ui:scaleDimension(10),
        Ui:scaleDimension(50)
    )
    love.graphics.rectangle(
        'fill',
        platformX + Ui:scaleDimension(1120),
        love.graphics.getHeight() - Ui:scaleDimension(50),
        Ui:scaleDimension(10),
        Ui:scaleDimension(50)
    )
    ...
    --upgrades
    for i = 1, #upgrades do
        local upgradeX, upgradeY, _ = UpgradeScreen.calculateUpgradePosition(i)
        local hilightLevel = 0 -- 0 for not hovering, 1 for hovering but too expensive, 2 for hovering and affordable
        if
            mouseX > upgradeX
            and mouseX < upgradeX + Ui:scaleDimension(200)
            and mouseY > upgradeY
            and mouseY < upgradeY + Ui:scaleDimension(130)
        then
    ...
    if button == 1 and not transitionToGame then
        ...
        for i = 1, #upgrades do
            local upgradeX, upgradeY, _ =
                UpgradeScreen.calculateUpgradePosition(i)
            if
                x > upgradeX
                and x < upgradeX + Ui:scaleDimension(200)
                and y > upgradeY
                and y < upgradeY + Ui:scaleDimension(130)
            then
                if player.money >= upgrades[i]:getPrice() then
